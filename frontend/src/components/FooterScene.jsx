...
// Caribbean scene used behind the footer: solid blue sky, drifting clouds and rolling waves.
...
const FooterScene = () => (
  <div className="absolute inset-0 select-none pointer-events-none" aria-hidden="true" data-testid="footer-scene">
    {/* solid sky */}
    <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #0A5BC0 0%, #0B2A5B 100%)" }} />

    <div className="absolute left-1/2 -translate-x-1/2 top-[10%] w-[320px] h-[320px] sm:w-[520px] sm:h-[520px] rounded-full bg-white/10 blur-3xl" />

    <div className="cloud absolute top-[14%] left-0 w-28 h-6 rounded-full bg-white/20 blur-md" style={{ animationDuration: "70s" }} />
    <div className="cloud absolute top-[32%] left-0 w-40 h-7 rounded-full bg-white/15 blur-md" style={{ animationDuration: "95s", animationDelay: "-40s" }} />
